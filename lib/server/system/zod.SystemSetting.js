...
const SystemSettingSchema = z.object({
    ...
    loginEnabled: z.boolean().optional().nullable().default(true),
    loginDisabledMessage: z.string().optional(),
    createAccountEnabled: z.boolean().optional().nullable().default(true),
    createAccountDisabledMessage: z.string().optional(),
    registrationEnabled: z.boolean().optional().nullable().default(true),
    registrationDisabledMessage: z.string().optional(),
    forgotPasswordEnabled: z.boolean().optional().nullable().default(true),
    forgotPasswordDisabledMessage: z.string().optional(),
    emailEnabled: z.boolean().optional().nullable().default(true),
    ...
    emailServerSecure: z.boolean().optional().nullable().default(true),
