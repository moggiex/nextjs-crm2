...
// 	public static async createAccount(firstName: string, email: string, password: I_User['password']) {
// 		try {
...
// 			// Optionally, perform any post-creation actions like sending a verification email
